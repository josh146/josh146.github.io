...
Image: /images/recipes/fish-curry.jpg
...
You can make it using the following spices, or source a good Malaysian fish curry powder such as
[Baba's](https://www.babas.com.my/index.php/business/product-masala-mix). Note if using a packaged
fish curry powder, check if it already includes the toasted rice powder, and leave it out if so.
