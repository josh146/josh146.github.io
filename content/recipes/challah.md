...
6. Punch down the dough, and leave it to rise for another 45 minutes, until doubled in size.
...
2. Squish each ball flat into a pancake, and fold the top into the middle, and the bottom into the middle.
...
3. Place two pieces end-to-end horizontally, and then place the remaining 4 pieces with the ends at the center, pointing
...
4. Repeat this process (taking the strand at the back and placing it in the middle of the strands, replacing it with
   the second-last strand from the opposite side) until you have a braided loaf; fold the ends underneath the loaf
   to tidy it up.

5. Make an egg wash with the egg, splash of milk, and a pinch of salt, and brust all over the challah
