...
if THEME == "pelican-themes/BT3-Flat":
    ...
    WORK_LIST =[['link',
                 'https://i.imgur.com/VL4t23I.png',
                 'A quantum graph search technique that matches Google',
                 'Article discussing my research in Vice Media',
                ...
                ['link',
                 ...
                 'Quantum walks: simulation and application',
                 'PhD Thesis',
                ...
                ['link',
                 'images/pyctqw.png',
                 'pyCTQW',
                 'Supercomputing quantum walk framework',
                 'http://pyctqw.readthedocs.org'
                ],
                ['link',
                 'images/helmets.jpg',
                ...
                ['link',
                 ...
                 'Published on Wolfram Demonstrations',
